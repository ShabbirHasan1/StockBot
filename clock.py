...
@sched.scheduled_job('cron', day_of_week='mon-sun', hour=4, minute=30)
def scheduled_job1():
	storeRatios.main()
	print 'This job is run every weekday at 12:30.'
...
def scheduled_job2():
	ScoreBuyStocks.main()
	print 'This job is run every weekday at 17:00 am.'
